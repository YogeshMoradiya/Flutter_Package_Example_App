...
class BarChartExample1 extends StatefulWidget {
   BarChartExample1({super.key});
  ...
  @override
  State<BarChartExample1> createState() => _BarChartSample7State();
}

class _BarChartSample7State extends State<BarChartExample1> {
